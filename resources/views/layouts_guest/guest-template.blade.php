...
<html lang="en">
    <head>
        ...
        <!-- Vendor CSS Files -->
        <link
            href="{{ asset('guest/vendor/animate.css/animate.min.css')}}"
            rel="stylesheet"
        />
        <link href="{{ asset('guest/vendor/aos/aos.css')}}" rel="stylesheet" />
        <link
            href="{{ asset('guest/vendor/bootstrap/css/bootstrap.min.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('guest/vendor/bootstrap-icons/bootstrap-icons.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('guest/vendor/boxicons/css/boxicons.min.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('guest/vendor/fontawesome-free/css/all.min.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('guest/vendor/glightbox/css/glightbox.min.css')}}"
            rel="stylesheet"
        />
        <link
            href="{{ asset('guest/vendor/swiper/swiper-bundle.min.css')}}"
            rel="stylesheet"
        />
            ...
            >
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div
                        class="carousel-item"
                        style="
                            background-image: url({{ asset('guest/img/slide/slide-3.jpg')}});
                        "
                    >
                        <div class="container">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        >
                            ...
                            <ul>
                                <li>
                                    <i class="bi bi-check-circle"></i> Ullamco
                                    laboris nisi ut aliquip ex ea commodo
                                    consequat.
                                </li>
                                <li>
                                    <i class="bi bi-check-circle"></i> Duis aute
                    ...
                    <div class="row no-gutters">
                        ...
                        >
                            <div class="count-box">
                                ...
                                <p>
                                    <strong>Doctors</strong> consequuntur quae
                                    qui deca rode
                                </p>
                        ...
                        >
                            <div class="count-box">
                                ...
                                ></span>
                                <p>
                                    <strong>Departments</strong> adipisci atque
                                    cum quia aut numquam delectus
                                </p>
                                <a href="#">Find out more &raquo;</a>
                            </div>
                        </div>
                        ...
                        >
                            <div class="count-box">
                                ...
                                ></span>
                                <p>
                                    <strong>Research Lab</strong> aut commodi
                        ...
                        >
                            <div class="count-box">
                                ...
                                ></span>
                                <p>
                                    <strong>Awards</strong> rerum asperiores
                            ...
                            <ul class="nav nav-tabs flex-column">
                                <li class="nav-item">
                                    ...
                                    >
                                        <h4>Cardiology</h4>
                                        <p>
                                            Quis excepturi porro totam sint
                                            earum quo nulla perspiciatis eius.
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item mt-2">
                                    ...
                                    >
                                        <h4>Neurology</h4>
                                        <p>
                                            Voluptas vel esse repudiandae quo
                                            excepturi.
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item mt-2">
                                    ...
                                    >
                                        <h4>Hepatology</h4>
                                        <p>
                                            Velit veniam ipsa sit nihil
                                            blanditiis mollitia natus.
                                        </p>
                                    </a>
                                </li>
                                <li class="nav-item mt-2">
                                    ...
                                    >
                                        <h4>Pediatrics</h4>
                                        <p>
                                            Ratione hic sapiente nostrum
                                            doloremque illum nulla praesentium
                                            id
                                        </p>
                                    </a>
                                </li>
                        ...
                        <div class="col-lg-8">
                            <div class="tab-content">
                                <div class="tab-pane active show" id="tab-1">
                                    <h3>Cardiology</h3>
                                    <p class="fst-italic">
                                        Qui laudantium consequatur laborum sit
                                        qui ad sapiente dila parde sonata raqer
                                        a videna mareta paulona marka
                                    </p>
                                    <img
                                        src="{{ asset('guest/img/departments-1.jpg')}}"
                                        alt=""
                                        class="img-fluid"
                                    />
                                    <p>
                                ...
                                <div class="tab-pane" id="tab-2">
                                    ...
                                    <img
                                        src="{{ asset('guest/img/departments-2.jpg')}}"
                                        alt=""
                                        class="img-fluid"
                                    />
                                    <p>
                                ...
                                <div class="tab-pane" id="tab-3">
                                    ...
                                    <img
                                        src="{{ asset('guest/img/departments-3.jpg')}}"
                                        alt=""
                                        class="img-fluid"
                                    />
                                    <p>
                                ...
                                <div class="tab-pane" id="tab-4">
                                    ...
                                    <img
                                        src="{{ asset('guest/img/departments-4.jpg')}}"
                                        alt=""
                                        class="img-fluid"
                                    />
                                    <p>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="{{ asset('guest/img/testimonials/testimonials-4.jpg')}}"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>Matt Brandon</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="{{ asset('guest/img/testimonials/testimonials-5.jpg')}}"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>John Larson</h3>
                    ...
                    <div class="row">
                        ...
                        >
                            ...
                            >
                                <div class="member-img">
                                    <img
                                        src="{{ asset('guest/img/doctors/doctors-4.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                    />
                                    <div class="social">
                        ...
                        <div class="swiper-wrapper align-items-center">
                            <div class="swiper-slide">
                                <a
                                    ...
                                    href="{{ asset('guest/img/gallery/gallery-1.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-1.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-2.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-2.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-3.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-3.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-4.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-4.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-5.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-5.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-6.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-6.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-7.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-7.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
                            <div class="swiper-slide">
                                <a
                                    class="gallery-lightbox"
                                    href="{{ asset('guest/img/gallery/gallery-8.jpg')}}"
                                    ><img
                                        src="{{ asset('guest/img/gallery/gallery-8.jpg')}}"
                                        class="img-fluid"
                                        alt=""
                                /></a>
                            </div>
